...
export interface BlockRendererProps {
  ...
  renderChildren: (blockId: string) => VNodeChild
  renderRichText: (richText?: NotionRichText[]) => VNodeChild
}

export type BlockRenderer = (props: BlockRendererProps) => VNodeChild

export interface NotionRendererComponents {
  blocks?: Partial<Record<NotionBlockType, BlockRenderer>>
  leaves?: Partial<{
    DateMention: Component
    UrlMention: Component
    MermaidBlock: Component
    LinkPreviewCard: Component
    UnsupportedBlock: Component
  }>
}
