...
function buildLinkMentionModel(linkPreviewMap: NotionRenderModel['linkPreviewMap']): NotionRenderModel {
            ...
            rich_text: [
              {
                ...
                mention: {
                  ...
                  link_mention: {
                    ...
                    thumbnail_url: 'https://notion.example/thumb.png',
                    link_provider: 'notion provider'
                  }
                }
              }
            ]
