 ...
 */
export interface UrlMentionHoverCardProps {
...
const URL_MENTION_FALLBACK_ICONS: Record<string, () => ReactNode> = {
  github: GithubFallbackIcon
}
    ...
    >
      {preview.image && (
        <span className="notion-url-mention-hover-cover">
          <img src={toOgProxyPreviewImageUrl(preview.image, preview.href)} alt={preview.title} loading="lazy" />
        </span>
      )}
